...
class LsDefaultDataSets
{
    ...
    public static function getTemplatesData()
    {
        ...
        $returnArray[] = [
            ...
            'view_folder'   => 'views',
            'files_folder'  => 'files',
            'description'   => '<strong>Sajilni Survey Fruity Theme</strong><br>A fruity theme for a flexible use. This theme offers monochromes variations and many options for easy customizations.',
            'last_update'   => null,
            'owner_id'      => 1,
            'extends'       => 'vanilla',
        ];
